Je comprends que l'affichage des équations peut être délicat dans un fichier README sur GitHub. Voici la version mise à jour du contenu en utilisant correctement les équations LaTeX avec des doubles signes dollar `$$` sur des lignes séparées pour garantir une bonne lisibilité dans GitHub Markdown.
...
En utilisant ces blocs de code, les équations seront correctement formatées et affichées dans un fichier README sur GitHub.
